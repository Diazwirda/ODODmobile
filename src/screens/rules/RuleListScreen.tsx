        ...
        {isAdmin(activeRoomRole) && (
          <View style={styles.headerActions}>
            <TouchableOpacity
              ...
              accessibilityLabel="Arsip rules"
            ...
            <TouchableOpacity
              ...
              accessibilityLabel="Tambah rule"
              accessibilityRole="button"
            >
            ...
            <View style={styles.card}>
              ...
              {isAdmin(activeRoomRole) && (
                <View style={styles.cardActions}>
                  <TouchableOpacity
                    onPress={() => navigation.navigate('EditRuleScreen')}
                    accessibilityLabel={`Edit rule ${item.name}`}
                    accessibilityRole="button"
                  >
                  ...
                  <TouchableOpacity
                    ...
                    accessibilityLabel={`Hapus rule ${item.name}`}
                    accessibilityRole="button"
                  >
