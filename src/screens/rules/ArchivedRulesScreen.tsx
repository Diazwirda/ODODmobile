...
export default function ArchivedRulesScreen() {
  ...
  const handleRestore = useCallback(async (rule: ArchivedRule) => {
    if (!activeRoom) return;
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title} accessibilityRole="header">Arsip Rules</Text>
        <Text style={styles.subtitle}>Rules yang dihapus dapat dipulihkan sebelum terhapus permanen.</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 16, backgroundColor: '#fff', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#E5E7EB' },
  ...
  card: { backgroundColor: '#fff', borderRadius: 12, padding: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 3, elevation: 1 },
  cardLeft: { flex: 1, marginRight: 12 },
  ruleName: { fontSize: 15, fontWeight: '600', color: '#111827', marginBottom: 6 },
  daysBadge: { alignSelf: 'flex-start', backgroundColor: '#F3F4F6', borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
  ...
  restoreBtn: { paddingHorizontal: 14, paddingVertical: 8, backgroundColor: '#EFF6FF', borderRadius: 8, borderWidth: 1, borderColor: '#BFDBFE', minWidth: 80, alignItems: 'center' },
