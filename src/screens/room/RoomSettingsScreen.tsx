        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <Switch
                  ...
                  accessibilityLabel="Toggle kode undangan"
                />
              )}
            />
          </View>
          ...
          {inviteCodeEnabled && activeRoom.invite_code && (
            <TouchableOpacity
              ...
              onPress={() => {
                Clipboard.setString(activeRoom.invite_code);
          ...
          <View style={styles.section}>
            ...
            {activeRoom.admins.map((admin) => (
              <View key={admin.id} style={styles.adminRow}>
                ...
                <View style={styles.adminInfo}>
                  ...
                  {admin.department ? (
                    <Text style={styles.adminDept}>{admin.department}</Text>
                  ) : null}
                </View>
              </View>
            ))}
            ...
            <View style={styles.addAdminRow}>
              ...
              />
              <TouchableOpacity
                style={[styles.addAdminBtn, addingAdmin && { opacity: 0.5 }]}
                onPress={handleAddAdmin}
                disabled={addingAdmin}
                accessibilityLabel="Tambah admin"
                accessibilityRole="button"
              >
                {addingAdmin ? (
