...
export default function ProfileScreen() {
  ...
  if (!profile)
    return (
      <View style={styles.centered}>
        <Text style={styles.emptyText}>Profil tidak tersedia.</Text>
      </View>
    );
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statItem}>
            <Text style={styles.statVal}>{stats.total_reports}</Text>
            <Text style={styles.statLbl}>Total Laporan</Text>
          </View>
          <View style={styles.statItem}>
            <Text style={styles.statVal}>{stats.points}</Text>
            <Text style={styles.statLbl}>Poin</Text>
          </View>
          <View style={styles.statItem}>
            <Text style={styles.statVal}>#{stats.rank}</Text>
            <Text style={styles.statLbl}>Peringkat</Text>
          </View>
          <View style={styles.statItem}>
            <Text style={styles.statVal}>{stats.streak_days}</Text>
            <Text style={styles.statLbl}>Streak Hari</Text>
          </View>
          <View style={styles.statItem}>
            <Text style={styles.statVal}>{stats.reports_today}</Text>
            <Text style={styles.statLbl}>Laporan Hari Ini</Text>
          </View>
        </View>
        ...
        {history.length === 0 ? (
          ...
          history.map((v: Violation) => (
            <View key={v.id} style={styles.historyItem}>
              ...
              <View
                style={[styles.statusBadge, { backgroundColor: STATUS_COLOR[v.status] + '22' }]}
              >
